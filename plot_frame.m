...
%   style : suffixe de style (ex. '-' ou '--')
    ...
    quiver3(O(1),O(2),O(3),X(1),X(2),X(3),style,'Color','r','LineWidth',2,'Tag','framevec');
    quiver3(O(1),O(2),O(3),Y(1),Y(2),Y(3),style,'Color','g','LineWidth',2,'Tag','framevec');
    quiver3(O(1),O(2),O(3),Z(1),Z(2),Z(3),style,'Color','b','LineWidth',2,'Tag','framevec');
    if ~isempty(name)
        text(O(1),O(2),O(3),[' ' name],'FontSize',10,'Tag','frametxt');
    end
